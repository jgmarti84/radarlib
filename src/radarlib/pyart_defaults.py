...
reflectivity = "DBZH"
corrected_reflectivity = "DBZHc"
vertical_reflectivity = "DBZV"
total_power = "total_power"

# Mean Doppler velocity fields, VEL
velocity = "VRAD"
corrected_velocity = "VRADc"
...
corrected_differential_reflectivity = "ZDRc"
...
unfolded_differential_phase = "PHIDPu"
corrected_differential_phase = "PHIDPc"

# Specific differential phase shift, KDP
specific_differential_phase = "KDP"
corrected_specific_differential_phase = "KDPc"
...
# custom
clutter_map = "CM"
beamblockage_acumulative = "CBB"
temperature = "temperature"
colmax = "COLMAX"

radar_echo_classification = "HID_fuzzylogic"  # field hid por defecto
hid_fuzzylogic = "HID_fuzzylogic"
hid_semisupervised = "HID_semisupervised"

rain_rate = "rr_z"  # field rr por defecto
radar_estimated_rain_rate = "rr_z"  # field rr por defecto
rr_acar = "rr_acar"
rr_mcgill = "rr_mcgill"
rr_z = "rr_z"
rr_kdp = "rr_kdp"
...
DEFAULT_FIELD_NAMES = {
    ...
    "vertical_reflectivity": vertical_reflectivity,
    "total_power": total_power,
    "velocity": velocity,
    ...
    "beamblockage_acumulative": beamblockage_acumulative,
    "temperature": temperature,
    "colmax": colmax,
...
DEFAULT_FIELD_COLORMAP = {
    ...
    clutter_map: "jet",
    beamblockage_acumulative: "jet",
    radar_echo_classification: "LangRainbow12",
    hid_fuzzylogic: "jet",
    hid_semisupervised: "jet",
    temperature: "jet",
    colmax: "jet",
    rain_rate: "RRate11",
...
DEFAULT_FIELD_LIMITS = {
    ...
    vertical_reflectivity: (-30.0, 75.0),
    ...
    # Custom
    clutter_map: (0, 1),
    beamblockage_acumulative: (0, 1),
    hid_fuzzylogic: (0, 11),
    hid_semisupervised: (0, 11),
    temperature: (-20, 50),
    colmax: (-5, 65),
    rain_rate: (0.0, 50.0),
...
DEFAULT_METADATA = {
    ...
    "scan_rate": {"units": "degrees_per_second", "long_name": "Antenna angle scan rate"},
    "range": {
        "units": "meters",
    ...
    "gate_x": {"long_name": "Cartesian x location of gate with origin at the radar", "units": "meters"},
    "gate_y": {"long_name": "Cartesian y location of gate with origin at the radar", "units": "meters"},
    "gate_z": {"long_name": "Cartesian z location of gate with origin at the radar", "units": "meters"},
    "gate_edge_x": {"long_name": "Cartesian x location of the edges of each gate", "units": "meters"},
    "gate_edge_y": {"long_name": "Cartesian y location of the edges of each gate", "units": "meters"},
    "gate_edge_z": {"long_name": "Cartesian z location of the edges of each gate", "units": "meters"},
    "gate_longitude": {"long_name": "Longitude of radar gate.", "units": "degrees_north"},
    ...
    "frequency": {"units": "s-1", "meta_group": "instrument_parameters", "long_name": "Radiation frequency"},
    "n_samples": {
        "units": "unitless",
        "meta_group": "instrument_parameters",
    ...
    "roll": {"units": "degrees", "standard_name": "platform_roll_angle", "long_name": "Platform roll angle"},
    "drift": {"units": "degrees", "standard_name": "platform_drift_angle", "long_name": "Platform drift angle"},
    "heading": {"units": "degrees", "standard_name": "platform_heading_angle", "long_name": "Platform heading angle"},
    "pitch": {"units": "degrees", "standard_name": "platform_pitch_angle", "long_name": "Platform pitch angle"},
    "georefs_applied": {
        "units": "unitless",
    ...
    # profile variables
    height: {"long_name": "Height of radar beam", "standard_name": "height", "units": "meters"},
    interpolated_profile: {
        "long_name": "Interpolated profile",
        "standard_name": "interpolated_profile",
        "units": "unknown",
    },
    clutter_map: {"long_name": "Clutter Map", "standard_name": "clutter_map", "units": "unknown"},
    beamblockage_acumulative: {
        "long_name": "Cumulative Beamblockage",
        "standard_name": "Cumulative Beamblockage",
        "units": "%",
    },
    ...
    hid_fuzzylogic: {"long_name": "HID_fuzzylogic", "standard_name": "HID_fuzzylogic", "units": "legend"},
    hid_semisupervised: {"long_name": "HID_semisupervised", "standard_name": "HID_semisupervised", "units": "legend"},
    temperature: {"long_name": "Interpolated temperature", "standard_name": "Interpolated temperature", "units": "°C"},
    colmax: {"long_name": "COLMAX", "standard_name": "COLMAX", "units": ""},
    rain_rate: {
        "units": "kg/m2/s",
    ...
    rr_acar: {"long_name": "ACAR Rain Rate", "standard_name": "ACAR Rain Rate", "units": "mm/h"},
    rr_mcgill: {"long_name": "McGill Rain Rate", "standard_name": "McGill Rain Rate", "units": "mm/h"},
    rr_z: {
        "long_name": "Z Rain Rate (Marshall y Palmer)",
        "standard_name": "Z Rain Rate (Marshall y Palmer)",
        "units": "mm/h",
    },
    rr_kdp: {"long_name": "KDP Rain Rate", "standard_name": "KDP Rain Rate", "units": "mm/h"},
    rr_zkdp: {"long_name": "ZKDP Rain Rate", "standard_name": "ZKDP Rain Rate", "units": "mm/h"},
    rr_hydro: {"long_name": "PyART Hydro Rain Rate", "standard_name": "PyART Hydro Rain Rate", "units": "mm/h"},
    rr_blended: {"long_name": "Blended Rain Rate", "standard_name": "Blended Rain Rate", "units": "mm/h"},
    # Grid metadata
    "grid_time": {"units": "seconds", "standard_name": "time", "long_name": "Time of grid", "calendar": "gregorian"},
    "origin_longitude": {
    ...
    "origin_altitude": {"long_name": "Altitude at grid origin", "units": "m", "standard_name": "altitude"},
    "x": {
    ...
    "point_x": {"long_name": "Cartesian x distance of each grid point from the origin", "units": "meters"},
    "point_y": {"long_name": "Cartesian y distance of each grid point from the origin", "units": "meters"},
    "point_z": {
        "long_name": "Cartesian z distance of each grid point from the origin",
        "positive": "up",
        "units": "meters",
    },
    "point_longitude": {"long_name": "Longitude of each grid point", "units": "degrees_north"},
    "point_latitude": {"long_name": "Latitude of each grid point", "units": "degrees_east"},
    ...
    "radar_time": {"calendar": "gregorian", "long_name": "Time in seconds of the volume start for each radar"},
    "radar_name": {
