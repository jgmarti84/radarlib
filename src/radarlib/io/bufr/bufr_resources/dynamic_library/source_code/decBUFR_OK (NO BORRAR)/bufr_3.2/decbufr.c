...
int compress (Bytef *dest, uLongf *destLen, const Bytef *source, uLong sourceLen){exit (1);}
int inflate (z_streamp strm, int flush){exit (1);}
int inflateEnd (z_streamp strm){exit (1);}
int inflateInit_ (z_streamp strm, const char *version, int stream_size) {exit (1);}
