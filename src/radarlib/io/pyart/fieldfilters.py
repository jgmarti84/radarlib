...
def filterfield_excluding_gates_below (
        radar, threshold, source_field,                                        
        target_fields=None, overwrite_fields=False, 
        new_fields_complement_name='f', logger_name='__name__',
    ...
    if source_field in radar.fields.keys():
        ...
        for i, field in enumerate (target_fields):    
            ...
            if overwrite_fields:
                filtered_field = np.ma.masked_where(radar.fields[source_field]['data'] < threshold, radar.fields[field]['data'] )            
                ...
                if add_applied_filters_field:
                    if 'applied_filters' in radar.fields[field].keys():
                        radar.fields[field]['applied_filters']=radar.fields[field]['applied_filters']+'[filt.'+source_field+']'
                    else:
            ...
            #Generacion de Campos Filtrados
                ...
                if add_applied_filters_field:
                    if 'applied_filters' in radar.fields[field+new_fields_complement_name].keys():
                        radar.fields[field+new_fields_complement_name]['applied_filters']=radar.fields[field]['applied_filters']+'[filt.'+source_field+']'
                    else:
                        radar.fields[field+new_fields_complement_name]['applied_filters']= '[filt.'+source_field+']'
...
def mask_field_outside_limits (radar, radio_inf=None, radio_ext=None, 
                               az_lim1=None, az_lim2=None, fields_to_mask=[]):   
    """========================================================================
    ...
    #======================================================================="""
    if not fields_to_mask: #por defecto enmascaramos todos los fields
...
def mask_field_inside_limits (radar, radio_inf=0, radio_ext=None, 
                              az_lim1=None, az_lim2=None, 
                              fields_to_mask=[]):   
    """========================================================================
